...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\AU\\PSY310\\Delay discounting\\Delay_discounting_task_lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('D:/AU/PSY310/Delay discounting/conditions.xlsx'),
